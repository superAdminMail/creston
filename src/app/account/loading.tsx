export default function Loading() {
  return (
    <div className="min-h-screen bg-card text-slate-950 dark:bg-card dark:text-slate-100">
      ...
      <div className="md:pl-72">
        <aside className="fixed left-0 top-16 hidden h-[calc(100dvh-4rem)] w-72 md:block">
