...
import { submitSavingsFundingProof } from "@/actions/savings/submitSavingsFundingProof";
...
export default function SavingsFundingProofModal({
  ...
  const amountIsInvalid =
    ...
    claimedAmount <= 0 ||
    (maxAmount !== null && claimedAmount > maxAmount);
  ...
  function handleSubmit() {
    ...
    startTransition(async () => {
      const result = await submitSavingsFundingProof({
        savingsAccountId,
        platformPaymentMethodId,
        claimedAmount,
        depositorName,
            ...
            <div className="grid gap-2">
              ...
              {maxAmount !== null ? (
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Suggested maximum for this goal:{" "}
