...
function TicketSkeleton() {
  return (
    <div className="group w-full rounded-[1.5rem] border border-slate-200/80 bg-white/75 p-4 text-left dark:border-white/10 dark:bg-white/[0.04]">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 flex-1 space-y-2">
          <Skeleton className="h-4 w-full max-w-md rounded-full bg-slate-200/80 dark:bg-white/10" />
          <Skeleton className="h-3.5 w-52 rounded-full bg-slate-200/80 dark:bg-white/10" />
        </div>
      ...
      <div className="space-y-6">
        <section className={SUPPORT_HERO_CLASS}>
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <Skeleton className="h-11 w-44 rounded-full bg-slate-200/80 dark:bg-white/10" />
          </div>
        </section>

        <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
          <div className={cn(SUPPORT_LIST_CLASS, "text-slate-950 dark:text-white")}>
          ...
          <div className={cn(SUPPORT_SIDE_CLASS, "text-slate-950 dark:text-white")}>
            <div className="space-y-5 p-5">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <Skeleton className="h-4 w-full max-w-xs rounded-full bg-slate-200/80 dark:bg-white/10" />
                </div>
              </div>
              ...
              <div className="rounded-[1.4rem] border border-slate-200/80 bg-white/75 p-4 dark:border-white/10 dark:bg-white/[0.04]">
                <Skeleton className="h-4 w-28 rounded-full bg-slate-200/80 dark:bg-white/10" />
                <Skeleton className="mt-3 h-11 w-full rounded-full bg-slate-200/80 dark:bg-white/10" />
              </div>
            </div>
          </div>
        </section>
