...
export function InvestmentPlansHeader() {
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-400 sm:text-base">
          Attach structured plans to investments, manage investable ranges, and
          keep the investment catalog aligned to live platform products.
        </p>
      </div>
