...
export default function Loading() {
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-sky-50/80 px-4 py-3 shadow-sm dark:border-sky-400/20 dark:bg-sky-400/10">
      ...
      <section className={`${DASHBOARD_PAGE_SURFACE_CLASS} p-5 sm:p-6`}>
        <div className="overflow-hidden rounded-[1.5rem] border border-slate-200/80 bg-white/90 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
