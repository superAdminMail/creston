...
export type SuperAdminInvestmentAccountDetailsViewModel = {
  id: string;
  title: string;
  subtitle: string;
...
function mapInvestmentAccountDetails(
  ...
  return {
    ...
    subtitle: "Super-admin investment account",
    ...
    investment: {
      ...
      description:
        ...
        "Curated investment product aligned to the platform strategy.",
...
export async function getSuperAdminInvestmentAccountDetails(
  investmentAccountId: string,
): Promise<SuperAdminInvestmentAccountDetailsViewModel | null> {
